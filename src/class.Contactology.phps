...
class Contactology {
	...
	/**
	 * Add a contact with custom fields. If the contact already exists, contact's custom fields will only be updated if updateCustomFields optional parameter is used.
	 *
	 * This function will not affect status or update custom fields of an existing contact that is deactivated (bounced, globally unsubscribed, etc.)
	 * 
	 * This function will not affect status or update custom fields of an existing contact with a "role-based" address (e.g., support@example.com, sales@example.com, contact@example.com)
	 * 
	 * 
	 ...
	 * 
	 * Will not update a contact with a "role-based" address (e.g., support@example.com, sales@example.com, contact@example.com)
	 * 
	 ...
	 * @return bool 
	 */ 
	public function Contact_Import_Delayed( $contacts, $source, $callbackUrl, $jobId, $chunkNum, $optionalParameters = array() ) {
		$args = array( 'key' => $this->key, 'method' => 'Contact_Import_Delayed' );
		$args['contacts'] = $contacts;
		$args['source'] = $source;
	 ...
	 * 
	 *
	 * @param struct optionalParameters A struct of optional parameters, any combination of which can be used
	 * @return int Number of contacts
	 */ 
	public function Contact_Get_Count( $optionalParameters = array() ) {
		$args = array( 'key' => $this->key, 'method' => 'Contact_Get_Count' );
		$args['optionalParameters'] = $optionalParameters;
	 ...
	 */ 
	public function Contact_Find_Ids( $optionalParameters = array() ) {
		$args = array( 'key' => $this->key, 'method' => 'Contact_Find_Ids' );
		$args['optionalParameters'] = $optionalParameters;
	 ...
	 * @param struct customFields The custom fields you want to update and their new values
	 * @param struct optionalParameters A struct of optional parameters, see below for valid keys
	 * @return bool Returns true on success
	 */ 
	 ...
	 */ 
	public function Contact_Suppress( $email, $optionalParameters = array() ) {
	 ...
	 * @return struct Returns a list of email addresses, each marked "true" or "false" showing whether they were suppressed
	 */ 
	public function Contact_Suppress_Multiple( $emails, $optionalParameters = array() ) {
  ...
  specified lists.
	 ...
	 */ 
	public function Contact_Get_No_Activity( $optionalParameters = array() ) {
	 ...
	 */ 
	public function Contact_Delete_No_Activity( $optionalParameters = array() ) {
	 ...
	 * @param struct optionalParameters A struct of optional parameters, see below for valid keys
	 * @return struct Struct of records each with a key of email and values of contactId, email, source, status, statusCode and listStatus
	 */ 
	 ...
	 *
	 * @param struct optionalParameters A struct of optional parameters, see below for valid keys
	 * @return struct Array of records with the key of listId and values of listId, name, description, type and listOwnerEmail
	 */ 
	 ...
	 * @param string source A short description of the of your contacts
	 * @param array contacts Array of contact_hash items:
	 * @param struct optionalParameters A struct of optional parameters, see below for valid keys
	 * @return struct Aggregate import results
	 */ 
	 ...
	 * Ex:
	 * contacts = [
	 * {'email':'testuser@contactology.com', 'first_name':'Test', 'last_name':'User'},
	 * {'email':'anotheruser@contactology.com', 1:'Another', 2:'User'}
	 * ];
	 * </structnotes contacts>
	 * 
	 * <structnotes content>
	 ...
	 * 
	 * Ex:
	 * testContact = {'email':'test@contactology.com', 'first_name':'Test', 'last_name':'User'}
	 * testContact = {'email':'support@contactology.com', 1:'Support', 2:'User'}
	 * </structnotes testContact>
	 * 
	 * <structnotes content>
	 * At least one of html or text must be provided.  If both are provided, the message will be sent as a multipart message
	 ...
	 *
	 * If no searchParameters are defined, all Campaign Ids will be returned
	 *
	 * @param struct searchParameters A struct of search parameters, any combination of which can be used
	 * @return array Campaign Ids
	 */ 
	public function Campaign_Find_Ids( $searchParameters = array() ) {
		$args = array( 'key' => $this->key, 'method' => 'Campaign_Find_Ids' );
		$args['searchParameters'] = $searchParameters;
	 ...
	 *
	 * Only campaigns with the following statuses will be returned: complete, deleted, archived
	 *
	 ...
	 */ 
	public function Campaign_Report( $campaignId, $optionalParameters = array() ) {
...
The recipients are added and will be sent in the next send cycle. This can be used to send transactional or ongoing type messages. In this
	 ...
	 *
	 * @param string email The you wish to send this transactional campaign to
	 * @return mixed Returns true on success, returns a struct on failure
	 */ 
	public function Campaign_Send_Reconfirmation( $email ) {
		$args = array( 'key' => $this->key, 'method' => 'Campaign_Send_Reconfirmation' );
		$args['email'] = $email;
	...
	/**
	 * Get a list of all Contacts who Shared the specified Campaign
	 *
	 * 
	 * A timeString can be any of:
	 *  - A specified date/time in the format: YYYY-MM-DD
	 ...
	 *    * "Tuesday next week" (example)
	 *
	 * @param int campaignId The campaign you wish to find contacts who shared said campaign
	 * @param struct optionalParameters A struct of optional parameters, see below for valid keys
	 * @return struct Returns a struct containing all found contacts
	 */ 
	public function Campaign_Get_Shared_Contacts( $campaignId, $optionalParameters = array() ) {
		$args = array( 'key' => $this->key, 'method' => 'Campaign_Get_Shared_Contacts' );
		$args['campaignId'] = $campaignId;
		$args['optionalParameters'] = $optionalParameters;
	 ...
	 */ 
	public function Campaign_Get_Split_Winner_Report( $campaignId, $optionalParameters = array() ) {
	 ...
	 */ 
	public function HostedAttachment_Add( $filename, $attachment, $optionalParameters = array() ) {
	...
	/**
	 * Get sending statistics for your account
	 *
	 * 
	 *
	 * @param struct optionalParameters 
	 */ 
	public function Account_Get_Send_Stats( $optionalParameters = array() ) {
		$args = array( 'key' => $this->key, 'method' => 'Account_Get_Send_Stats' );
		$args['optionalParameters'] = $optionalParameters;
...
Campaign and SavedSearch functions
	 ...
	 * 
	 *
	 * @param string getByFolder Fetch templates by folder
	 ...
	 */ 
	public function Template_List( $getByFolder = '' ) {
		$args = array( 'key' => $this->key, 'method' => 'Template_List' );
		$args['getByFolder'] = $getByFolder;
  ...
  in advance to use the same IDs for corresponding containers.  See the Template Controller documentation
	 ...
	 * 
	 *
	 * @return struct A struct containing the HTML and Text parts of your default footer
	 */ 
	public function Footer_Get_Default(  ) {
		$args = array( 'key' => $this->key, 'method' => 'Footer_Get_Default' );
	 ...
	 *
	 * @return struct A struct of footers, with the key being the footer ID and the value being the footer name
	 */ 
	public function Footer_List(  ) {
		$args = array( 'key' => $this->key, 'method' => 'Footer_List' );
	 ...
	 * 
	 *
	 * @param int footerId The ID of the footer for which you want the contents
	 * @return struct A struct containing the HTML and Text parts of your default footer
	 */ 
	public function Footer_Get_Contents( $footerId ) {
		$args = array( 'key' => $this->key, 'method' => 'Footer_Get_Contents' );
		$args['footerId'] = $footerId;
	 ...
	 * 
	 *
	 * @param string name The of your new footer
	 * @param string html The HTML content of your new footer
	 * @param string text The Text content of your new footer
	 * @return int The ID of your new footer
	 */ 
	public function Footer_Add( $name, $html, $text ) {
		$args = array( 'key' => $this->key, 'method' => 'Footer_Add' );
		$args['name'] = $name;
		$args['html'] = $html;
		$args['text'] = $text;
	 ...
	 * 
	 *
	 * @param int footerId The ID of the footer you want to change
	 * @param string html The new HTML content of your footer
	 * @param string text The new Text content of your footer
	 * @return bool True on success
	 */ 
	public function Footer_Update( $footerId, $html, $text ) {
		$args = array( 'key' => $this->key, 'method' => 'Footer_Update' );
		$args['footerId'] = $footerId;
		$args['html'] = $html;
		$args['text'] = $text;
	 ...
	 *
	 * @return array Returns an array of filenames which hold your stored bulk hooks
	 */ 
	public function Report_Get_Bulk_Webhooks(  ) {
		$args = array( 'key' => $this->key, 'method' => 'Report_Get_Bulk_Webhooks' );
	 ...
	 *
	 * @param struct optionalParameters A struct of optional parameters, see below for valid keys
	 * @return struct A struct of social connections
	 */ 
	public function SocialConnection_List( $optionalParameters = array() ) {
		$args = array( 'key' => $this->key, 'method' => 'SocialConnection_List' );
		$args['optionalParameters'] = $optionalParameters;
	 ...
	 * 
	 *
	 * @param int id Retrieve a specific social connection
	 * @return struct A struct of social connections
	 */ 
	public function SocialConnection_Get_Locations( $id ) {
		$args = array( 'key' => $this->key, 'method' => 'SocialConnection_Get_Locations' );
		$args['id'] = $id;
	 ...
	 * 
	 *
	 * @return struct Array of surveys with the key of surveyId
	 */ 
	public function Survey_List(  ) {
		$args = array( 'key' => $this->key, 'method' => 'Survey_List' );
...
If the 'page' optionalParameter is provided, results are paginated to 1000 surveys per page.
	 ...
	 *
	 * @return struct Array of surveys with the key of surveyId and values of name, title, status, start_date, and end_date, ordered by survey ID ascending
	 */ 
	public function Survey_Find(  ) {
		$args = array( 'key' => $this->key, 'method' => 'Survey_Find' );
	 ...
	 * 
	 *
	 * @param int surveyId The ID of the survey you want to retrieve the questions for
	 * @return struct Array of survey questions, with the key of the question ID. The response format is similar to that of Survey_Get_Responses.
	 */ 
	public function Survey_Get_Questions( $surveyId ) {
		$args = array( 'key' => $this->key, 'method' => 'Survey_Get_Questions' );
	 ...
	 * 
	 *
	 * @param int surveyId ID of the survey you want to retrieve the response counts for
	 * @return int Count of how many responses there are for the given survey
	 */ 
	public function Survey_Get_Response_Count( $surveyId ) {
		$args = array( 'key' => $this->key, 'method' => 'Survey_Get_Response_Count' );
		$args['surveyId'] = $surveyId;
	 ...
	 * 
	 *
	 * @param string emailAddress The email address of the contact you want to retrieve responses for
	 * @return struct Array of responses. See Survey_Get_Responses for response format documentation.
	 */ 
	public function Survey_Get_Responses_By_Email( $emailAddress ) {
		$args = array( 'key' => $this->key, 'method' => 'Survey_Get_Responses_By_Email' );
...
If the 'page' optionalParameter is provided, results are paginated to 1000 surveys per page.
	 ...
	 *
	 * @param int surveyId The ID of the survey you want to retrieve the questions for
	 * @return struct Array of surveys
	 */ 
	public function Survey_Get_Responses( $surveyId ) {
		$args = array( 'key' => $this->key, 'method' => 'Survey_Get_Responses' );
		$args['surveyId'] = $surveyId;
